...
import { createDifficultyLevel, updateDifficultyLevel } from '@/lib/actions/Staff';
...
const DifficultyLevelForm = ({
  ...
  const mutation = useMutation({
    mutationKey: ['difficultyLevelMutation', isEditSession ? editId : 'new'],
    mutationFn: (data) => {
      if (isEditSession) {
        return updateDifficultyLevel(editId, data);
      } else {
        return createDifficultyLevel(data);
      }
    },
    onSuccess: () => {
      toast({
